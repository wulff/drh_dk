/**
 * @file nodereference_explorer_plugin_content_nodereference_quantifier.js
 ...
 */
nodereference_explorer_plugin_content_nodereference_quantifier_setValue = function(widget, value) {
 ...
 *   parent widget
 */
nodereference_explorer_plugin_content_nodereference_quantifier_removeValue = function(widget) {
  $(widget).val('').blur();
  $(widget +'-quantifier').val('');
}
